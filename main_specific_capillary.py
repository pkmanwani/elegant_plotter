...
chamber_width = 2*0.106
ax_lattice.add_patch(plt.Rectangle((rectangle_center - (chamber_width/2), -0.25), chamber_width, 0.5, edgecolor='black', facecolor='green', alpha=0.2, linewidth=2))
ax_lattice.text(rectangle_center, 0.35, 'Ante Chamber', ha='center', va='center',color='black',size='10')
...
ax_lattice.set_xlim(min_sx_s_value-0.12, min_sx_s_value+0.12)
